...
const CustomizedItemText = styled(Typography)(
  ({ theme }) => `
...
function SidebarMenu() {
  ...
  const handleItemClick = () => {
    if (window.innerWidth < 960 && sidebarToggle) {
      toggleSidebar();
    }
  };
