...
const colors = {
  gradients: {
    ...
    blue4: "linear-gradient(-20deg, #316eff 0%, #4e4376 100%)",
  ...
  shadows: {
    ...
    card: "0px 0px 1px rgba(159, 162, 191, .18), 0px 1px 1px rgba(159, 162, 191, 0.32)",
    cardSm:
  ...
  alpha: {
    ...
    black: {
      ...
      100: alpha(themeColors.black, 1.0),
    },
  },
  secondary: {
...
export const DarkTheme = createTheme({
  ...
  components: {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(darken(themeColors.primaryAlt, 1), 0.5),
      ...
      styleOverrides: {
        root: {
          ...
          "&:hover .MuiOutlinedInput-notchedOutline": {
            borderColor: colors.alpha.white[50],
          },
    ...
    MuiCard: {
      styleOverrides: {
        root: {
          background: darken(colors.alpha.black[50], 0.3),
          color: colors.alpha.trueWhite[100],
          borderRadius: 4,
          boxShadow: "none",
          border: "1px solid " + lighten(colors.alpha.trueWhite[30], 0.5),
          elevation: 10,
        },
      },
    },
    ...
    MuiAccordion: {
      styleOverrides: {
        root: {
          boxShadow: "none",
          background: colors.alpha.black[70],
          color: colors.alpha.trueWhite[100],
          border: "1px solid " + lighten(colors.alpha.trueWhite[30], 0.5),
          "&.Mui-expanded": {
            margin: 0,
    ...
    MuiAlert: {
      styleOverrides: {
        ...
        icon: {
          color: colors.alpha.white[100] + "!important",
        },
      },
    },
    ...
    MuiTooltip: {
      styleOverrides: {
        tooltip: {
          backgroundColor: colors.alpha.black[100],
          color: alpha(colors.alpha.trueWhite[100], 1),
          padding: "8px 16px",
          fontSize: 12,
          fontWeight: "bold",
          boxShadow: "0px 2px 2px " + colors.alpha.trueWhite[10],
        },
        arrow: {
          color: colors.alpha.black[100],
        },
